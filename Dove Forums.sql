...
# Database: DoveForums
# Generation Time: 2015-06-22 09:09:33 +0000
# ************************************************************
...
LOCK TABLES `permission_map` WRITE;
/*!40000 ALTER TABLE `permission_map` DISABLE KEYS */;

INSERT INTO `permission_map` (`group_id`, `permission_id`)
VALUES
	(1,1);

/*!40000 ALTER TABLE `permission_map` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'127.0.0.1','administrator','$2y$08$Fek1EzPjE2SQu50dw6DZ.OTKefroF3n9eiJaJEY8WaNXvjkpAgery','','admin@admin.com','',NULL,NULL,NULL,1268889823,1432738382,1,'Admin','istrator','ADMIN','0',24,5,1);
